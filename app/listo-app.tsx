...
function ItemCard({ item, job, onOpen, controls, draggable, onDragStart, onDrop, expanded = false }: { item: Item; job?: ProcessingJob; onOpen: () => void; controls?: React.ReactNode; draggable?: boolean; onDragStart?: React.DragEventHandler; onDrop?: React.DragEventHandler; expanded?: boolean }) {
